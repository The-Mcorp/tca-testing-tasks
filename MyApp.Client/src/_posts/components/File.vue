<template>
  <div>
    <div v-if="label == '_'">
      <div v-for="(file, index) in contents" :key="index" class="ml-6 flex items-center text-base leading-8">
    ...
    <div v-else>
      <div class="ml-6">
        ...
        <File v-for="(children,item) in contents" :key="item" :label="item" :contents="children" />
      </div>
    </div>
  </div>
</template>
